...
exports.pollForCompletion = exports.triggerScan = exports.triggerOnDemandScan = void 0;
...
function triggerOnDemandScan() {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield AzCLIAADTokenGenerator_1.getAccessToken();
...
function triggerScan(scope, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        Utility_1.printPartitionedText(`Triggering scan. URL: ${triggerScanUrl}`);
...
function pollForCompletion(pollLocations) {
    return __awaiter(this, void 0, void 0, function* () {
        Utility_1.printPartitionedText('Starting to poll for scan statuses. Poll urls:');
        const token = yield AzCLIAADTokenGenerator_1.getAccessToken();
        ...
        try {
            Utility_1.printPartitionedText(`Poll interval (ms):: ${pollInterval}`);
            while (pendingPolls.length > 0) {
                Utility_1.printPartitionedDebugLog(`Poll round: ${pollRound}, No. of pending polls: ${pendingPolls.length}`);
                let pendingPollsNew = [];
                let completedPolls = [];
                ...
                if (completedPolls.length > 0) {
                    Utility_1.printPartitionedDebugLog(`Results saving ...`);
                    yield resultScanner.saveScanResult(completedPolls, token);
                    endTime = new Date();
                    Utility_1.printPartitionedDebugLog(`Results saved. Time taken in ms:: ${endTime.getTime() - startTime.getTime()}`);
                }

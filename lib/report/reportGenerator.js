...
exports.printFormattedOutput = exports.generateSummary = void 0;
...
function generateSummary() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (nonCompliantResources != null && nonCompliantResources.length > 0) {
            ...
            utilities_1.printPartitionedText('Policy compliance scan report::');
            ...
            utilities_1.printPartitionedText('All resources are compliant');
        }
    });
}

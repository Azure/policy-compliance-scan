    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const scope of scopes) {
                const pollLocation = yield scanHelper_1.triggerScan(scope, token).catch(error => {
                    throw Error(error);
                });
                pollLocations.push({
                    'scope': scope,
            ...
            yield scanHelper_1.pollForCompletion(pollLocations, token).catch(error => {
                throw Error(error);
            });
            ...
            if (out != null && out.length > 0) {
                ...
                yield resultScanner.createCSV(csv_object, csvName);

...
exports.createCSV = exports.printFormattedOutput = exports.getScanResult = exports.batchCalls = exports.batchCall = exports.JSON_FILENAME = exports.CSV_FILENAME = void 0;
...
function batchCall(batchUrl, batchMethod, batchRequests, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield client_1.sendRequest(batchWebRequest).then((response) => {
...
function batchCalls(uri, method, commonHeaders, polls, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (pendingPolls.length > 0) {
            ...
            const pollTimeoutDuration = 5 * 60 * 1000; //5 mins
            ...
            try {
                ...
                while (pendingResponses.length > 0 && !hasPollTimedout) {
                    ...
                    pendingResponses = pendingResponses.map((pendingResponse) => {
                        ...
                        else if (pendingResponse.statusCode == client_1.StatusCodes.ACCEPTED) {
                    ...
                    if (!hasPollTimedout && pendingResponses.length > 0 && isSleepRequired) {
                        ...
                        yield Utility_1.sleep(pollInterval);
                    }
...
function getScanResult(polls, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield batchCalls(scanResultUrl, 'POST', null, polls, token).then((responseList) => {
        ...
        scopes = [...new Set(resourceIds)].filter((item) => { return !ignoreResultHelper_1.ignoreScope(item); })
        ...
        yield batchCalls(policyEvalUrl, 'POST', null, scopes, token).then((responseList) => {
            responseList.forEach(resultsObject => {
                if (resultsObject.httpStatusCode == 200) {
...
function printFormattedOutput(data, maxLogRecords, skipArtifacts) {
    let rows = [];
    let csvRows = [];

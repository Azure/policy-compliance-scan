...
const POLL_TIMEOUT_DURATION = 5 * 60 * 1000; //5 mins
...
function pollPendingResponses(pendingResponses, token) {
    return __awaiter(this, void 0, void 0, function* () {
        if (pendingResponses.length > 0) {
            ...
            yield Utility_1.sleep(BATCH_POLL_INTERVAL); // Delay before next poll
...
function getScanResult(polls, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //First batch call
        Utility_1.printPartitionedDebugLog('First set of batch calls::');
        ...
        Utility_1.printPartitionedDebugLog('Second set of batch calls::');

...
exports.uploadFile = exports.createCSV = exports.getFilePath = exports.writeToCSVFile = exports.getTempDirectory = exports.removePolicyScanDirectory = exports.getPolicyScanDirectory = exports.getFileJson = exports.getScanReportPath = exports.CSV_FILENAME = exports.JSON_FILENAME = void 0;
...
function createCSV(data, csvName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield uploadFile(fileName, filePath, path.dirname(filePath));
        }
        catch (error) {

...
function processCreatedResponses(receivedResponses, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield Promise.all(receivedResponses.map((pendingResponse) => __awaiter(this, void 0, void 0, function* () {
                if (pendingResponse.statusCode == 200 && pendingResponse != null && pendingResponse.body != null) {
                    ...
                    while (nextPageLink && nextPageLink != null) {
                        let batchResponsesNextPage = yield batchCall(nextPageLink, 'GET', [], token);
                    ...
                    utilities_1.printPartitionedDebugLog(`Saving ${values.length} resourceIds to result.`);

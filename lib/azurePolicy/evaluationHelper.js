    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        batchWebRequest.uri =
            batchUrl && batchUrl.length > 0
                ? batchUrl
                : `${yield managementUrlHelper_1.ManagementUrlHelper.getBaseUrl()}/batch?api-version=2020-06-01`;
...
function saveScanResult(polls, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let scopes = [];
        let resourceIds = [];
        const baseUrl = yield managementUrlHelper_1.ManagementUrlHelper.getBaseUrl();

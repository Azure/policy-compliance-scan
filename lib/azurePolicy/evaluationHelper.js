    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            receivedResponses = yield Promise.all(receivedResponses.map((pendingResponse) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (pendingResponse.statusCode == 200 && pendingResponse != null && pendingResponse.body != null) {
                    ...
                    while (nextPageLink && nextPageLink != null) {
                        responseList.push(yield batchCall(nextPageLink, 'GET', [], token).then(batchResponsesNextPage => {
                    ...
                    yield Promise.all(responseList.map((response) => __awaiter(this, void 0, void 0, function* () {
            ...
            receivedResponses.forEach(response => {
                utilities_1.printPartitionedDebugLog(`Saving ${response.values.length} resourceIds to result.`);
        ...
        while (pendingPolls.length > 0) {
            ...
            try {
                ...
                while (pendingResponses && pendingResponses.length > 0 && !hasPollTimedout) {
                    ...
                    yield pollPendingResponses(pendingResponses, token).then(polledResponses => {
            ...
            utilities_1.printPartitionedDebugLog(`Saving ${completedResponses.length} completed responses.`);
            let intermediateResult;
            try {
                yield processCreatedResponses(completedResponses, token).then(response => {

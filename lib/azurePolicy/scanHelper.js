...
function triggerScan(scope, token) {
    return __awaiter(this, void 0, void 0, function* () {
        let triggerScanUrl = `${managementUrlHelper_1.ManagementUrlHelper.getBaseUrl()}${scope}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation?api-version=2019-10-01`;
